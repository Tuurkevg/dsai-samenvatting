...
if p < alpha:
    print("P VALUE Conclusion: Reject H0 ")
else:
    print("P VALUE Do not reject H0 (based on p-value)")
```
```py
# Right tail probability in the chi-squared distribution vOOR LINKS GEBRUK JE SF!!!
