...
# Parameters van de steekproefverdeling
mean = 12.1  # Gemiddeld gewicht van ingecheckte koffers
std_dev = 3.8  # Standaarddeviatie van het gewicht
sample_size = 43  # Aantal ingecheckte koffers op de vlucht

# Gemiddeld gewicht waarvoor we de kans willen berekenen
sample_mean = 11
